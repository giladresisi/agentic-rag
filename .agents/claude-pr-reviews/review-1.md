...
- **Rationale**: These are pre-created test accounts (test@test.com/123456), not production secrets. Documented in project's CLAUDE.md as official test credentials.
