...
echo ""
echo "============================================"
echo "Setup complete! Three manual steps remain:"
echo "============================================"
echo ""
echo "  1. Disable email confirmation in Supabase dashboard:"
echo "     Authentication -> Sign In / Providers -> User Signups"
echo "     Toggle 'Confirm email' OFF (otherwise signup returns 400)."
echo ""
echo "  2. Create a test user in Supabase dashboard:"
echo "     Authentication -> Users -> Add user"
echo "     Choose an email and password (used only for automated tests)."
echo ""
echo "  3. Add test credentials to BOTH .env files:"
...
echo ""
echo "------------------------------------------------------------"
echo "OPTIONAL: Activate CI backend integration tests on GitHub"
echo "------------------------------------------------------------"
echo ""
echo "  The integration-tests.yml workflow is disabled by default."
echo "  To enable it, complete these steps in your GitHub repo:"
echo ""
echo "  1. Create a dedicated CI Supabase project (separate from production)"
echo "     Apply all migrations to it (supabase link + db push)."
echo "     Create a test user in the CI project's Auth dashboard."
echo ""
echo "  2. Add these Secrets (Settings -> Secrets and variables -> Actions):"
echo "       CI_SUPABASE_URL"
echo "       CI_SUPABASE_ANON_KEY"
echo "       CI_SUPABASE_SERVICE_ROLE_KEY"
echo "       CI_OPENAI_API_KEY"
echo "       CI_TEST_EMAIL"
echo "       CI_TEST_PASSWORD"
echo ""
echo "  3. Add this Variable (Settings -> Secrets and variables -> Actions):"
echo "       CI_INTEGRATION_TESTS_ENABLED = true"
echo ""
echo "  See SETUP.md -> 'CI: Backend Integration Tests (Optional)' for full details."
echo ""
